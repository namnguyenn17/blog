...
export function Subscribe() {
  ...
  return (
    <div className="border border-blue-200 rounded p-6 my-4 w-full dark:border-gray-800 bg-blue-50 dark:bg-blue-500">
      ...
      <p className="my-1 text-gray-800 dark:text-gray-200">
        As a thank you, I'll also send you some tips and tricks for building a
        successful blog where you can share your knowledge with others. No spam
